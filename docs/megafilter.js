(()=>{
    ...
    // first of all mark 5 of each k3y r0 r1 as originals
    ...
    -k[vc2c7q] rarity=0:1 _best=5 -> original
    -k[tvfkyq] rarity=0:1 _best=5 -> original
    -k[xwz7ja] rarity=0:1 _best=5 -> original
    -k[uphlaw] rarity=0:1 _best=5 -> original
    -k[sa23uw] rarity=0:1 _best=5 -> original
    -k[72umy0] rarity=0:1 _best=5 -> original
    -k[cmppiq] rarity=0:1 _best=5 -> original
    -k[i874y3] rarity=0:1 _best=5 -> original
    -k[eoq6de] rarity=0:1 _best=5 -> original
    -k[9p65cu] rarity=0:1 _best=5 -> original
    -k[6hh8xw] rarity=0:1 _best=5 -> original
    -k[pmvr1q] rarity=0:1 _best=5 -> original
    -k[fr8ibu] rarity=0:1 _best=5 -> original
    -k[ellux0] rarity=0:1 _best=5 -> original
    -k[xfnkqe] rarity=0:1 _best=5 -> original
    -k[y111qa] rarity=0:1 _best=5 -> original

    -k[hc3b69] rarity=0:1 _best=5 -> original
    -k[5c7e1r] rarity=0:1 _best=5 -> original
    -k[4jitu5] rarity=0:1 _best=5 -> original
    -k[lq09tg] rarity=0:1 _best=5 -> original
    -k[vthf6e] rarity=0:1 _best=5 -> original
    -k[nfijix] rarity=0:1 _best=5 -> original
    -k[nyi5u2] rarity=0:1 _best=5 -> original
    -k[voon2h] rarity=0:1 _best=5 -> original
    -k[j1aa4n] rarity=0:1 _best=5 -> original
    -k[d9j270] rarity=0:1 _best=5 -> original
    -k[vzdt6m] rarity=0:1 _best=5 -> original
    -k[cy70mo] rarity=0:1 _best=5 -> original
    -k[8izsag] rarity=0:1 _best=5 -> original
    -k[hzqgw6] rarity=0:1 _best=5 -> original
    -k[qvgtnt] rarity=0:1 _best=5 -> original
    -k[ooilt2] rarity=0:1 _best=5 -> original

    -k[afgny5] rarity=0:1 _best=5 -> original
    -k[54r1cg] rarity=0:1 _best=5 -> original
    -k[dwwf3w] rarity=0:1 _best=5 -> original
    -k[7oxb1b] rarity=0:1 _best=5 -> original
    ...
    k[lq09tg] rarity=2:* !_best=10 -> extra 
    k[voon2h] rarity=2:* !_best=10 -> extra  
